...
# query
where_311 = "closed_datetime >= '2010-01-01' AND closed_datetime < '2020-01-01' AND service_name = 'Rubbish/Recyclable Material Collection'"
...
reports311 <- reports311 %>%
   ...
   st_as_sf(coords = c("lat","lon"), crs = 'EPSG:3857') %>%
...
vars_net <- rbind(vacant_centroids, ppr_sites, septaStops, city_hall, schools, trees, farmerMarket, indegoStation, cityLandmarks) %>%
...
# just risk factors
reg.vars <- c("city_hall.nn", "in_bike_net", "is_historic", "ppr_sites.nn", "schools.nn", "septa_stops.nn", "total_hpss", "total_restaurants", "Trees", "Vacants","indego.nn","farmers.nn","Landmarks")

...
## Figures 1 - 6. Permit Count on Fishnet by Year
...
# dat_tract <- tracts19; var_name <- "total_pop"; legend_name <- "Total Population"; sum_or_mean <- sum
...
var_for_model <- c("uniqueID","cvID","count_permits19","count_permits18","count_permits17","count_permits16",
                   ...
                   "RubbishRecyclableMaterialCollection2019","vehicles_avail 19","med_rent 19","renter_occ 19",
                   "VacantHouseorCommercial2019","total_pop 19","samehouse1yr_metro 19","StreetTrees2019",
                   "children 19","parksNrec19.dist")

all_net19 <- all_net %>% 
  dplyr::select(all_of(var_for_model))

# only keep years for count_permit columns
names(all_net19) <- c(str_replace_all(var_for_model, c(" 19" = "","2019" = "","19." = ".")), "geometry")
...
```{r fig4/small mult map, fig.height=18}
...
```{r fig6/small mult scatter, fig.height=21}
correlation.long <-

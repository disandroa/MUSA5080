...
city_counil <- st_read("https://opendata.arcgis.com/api/v3/datasets/1ba5a5d68f4a4c75806e78b1d9245924_0/downloads/data?format=geojson&spatialRefId=4326&where=1%3D1")
...
ggplot()+
  geom_sf(data=city_counil, aes(fill=city_counil$DISTRICT))+
  # geom_sf(data=(get_acs(geography = "block group", 
  #         variables = census_vars, 
  #         year = 2019, state = 42, county=101,
  #         geometry = T, output = "wide") %>%
  # st_transform(crs = 2272))
  #           ,aes())+

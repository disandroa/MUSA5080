...
r_names <- names(tracts13)[3:14]
gend_names <- c("Total Population","Median HH Income","Median Rent","Rent (as %age of Income)","mobility_tot_metro",
                "samehouse1yr_metro","owner_occ","renter_occ","vehicles_avail","private_vehicle_occ","children",
                "pct_white")

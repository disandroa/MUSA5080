...
# query
where = "dispatch_date >= '2022-01-01' AND dispatch_date < '2023-01-01' AND text_general_code IN ('Aggravated Assault Firearm', 'Aggravated Assault No Firearm', 'Vandalism/Criminal Mischief')"

query = paste("SELECT *",
              "FROM", table_name,
              "WHERE", where)

crime = rphl::get_carto(query, format = "csv", base_url = carto_url, stringsAsFactors = F)

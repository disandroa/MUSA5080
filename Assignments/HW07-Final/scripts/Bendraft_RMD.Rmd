...
dumping_net_allyrs <- dumping_net14 %>% 
    st_drop_geometry() %>%
    dplyr::select(uniqueID,cvID,count_dump14) %>% 
    left_join(dumping_net15 %>% st_drop_geometry() %>% dplyr::select(uniqueID,count_dump15), by = "uniqueID") %>% 
    ...
    left_join(dumping_net14 %>% dplyr::select(-c(cvID, count_dump14)), by = "uniqueID")
...
buildComplain_net_allyrs <- buildComplain_net14 %>% 
    st_drop_geometry() %>%
    dplyr::select(uniqueID,cvID,count_BuildComplain14) %>% 
    left_join(buildComplain_net15 %>% st_drop_geometry() %>% dplyr::select(uniqueID,count_BuildComplain15), by = "uniqueID") %>% 
    ...
    left_join(buildComplain_net14 %>% dplyr::select(-c(cvID, count_BuildComplain14)), by = "uniqueID")
...
trees_net_allyrs <- trees_net14 %>% 
    st_drop_geometry() %>%
    dplyr::select(uniqueID,cvID,count_trees14) %>% 
    left_join(trees_net15 %>% st_drop_geometry() %>% dplyr::select(uniqueID,count_trees15), by = "uniqueID") %>% 
    ...
    left_join(trees_net14 %>% dplyr::select(-c(cvID,count_trees14)), by = "uniqueID")
...
dangSidewalk_net_allyrs <- dangSidewalk_net14 %>% 
    st_drop_geometry() %>%
    dplyr::select(uniqueID,cvID,count_dangSidewalk14) %>% 
    left_join(dangSidewalk_net15 %>% st_drop_geometry() %>% dplyr::select(uniqueID,count_dangSidewalk15), by = "uniqueID") %>% 
    ...
    left_join(dangSidewalk_net14 %>% dplyr::select(-c(cvID,count_dangSidewalk14)), by = "uniqueID")
...
PPRops_net_allyrs <- PPRops_net14 %>% 
    st_drop_geometry() %>%
    dplyr::select(uniqueID,cvID,count_PPRops14) %>% 
    left_join(PPRops_net15 %>% st_drop_geometry() %>% dplyr::select(uniqueID,count_PPRops15), by = "uniqueID") %>% 
    ...
    left_join(PPRops_net14 %>% dplyr::select(-c(cvID,count_PPRops14)), by = "uniqueID")
...
vacant_net_allyrs <- vacant_net14 %>% 
    st_drop_geometry() %>%
    dplyr::select(uniqueID,cvID,count_vacant14) %>% 
    left_join(vacant_net15 %>% st_drop_geometry() %>% dplyr::select(uniqueID,count_vacant15), by = "uniqueID") %>% 
    ...
    left_join(vacant_net14 %>% dplyr::select(-c(cvID,count_vacant14)), by = "uniqueID")

...
# mcfadden: 0.2-0.4 considered to be a good model, analogouse to R^2, but rarely gets as high
...
# notice that as factors, click comes before no-click (because of alph. order), but we typically want click == 1, no-click == 0
```
...
# want these plots to have modalities at the extremes without too much confusion in the middle areas
```
...
# AUC tells us how model does, independent of threshold
```

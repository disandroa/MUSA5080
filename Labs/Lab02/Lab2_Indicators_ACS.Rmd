...
# each row is a unique combo of census tract + variable
# 384 tracts in philadelphia x 7 variables = 2688 rows
# long format allows us to summarize data more easily
# for get_acs() you can use numbers or strings to identify state and county
```
...
# our CRS is in feet, so we feed in 2640 (half mile in feet)
